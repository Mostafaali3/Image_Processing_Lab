class Controller():
    def __init__(self, r_histogram_viewer,g_histogram_viewer,b_histogram_viewer, gray_histogram_viewer, r_cdf_viewer, g_cdf_viewer, b_cdf_viewer,gray_cdf_viewer, input_image_viewer, output_image_viewer, input_hybrid_image_viewer_1, input_hybrid_image_viewer_2, filtered_hybrid_image_viewer_1, filtered_hybrid_image_viewer_2):
